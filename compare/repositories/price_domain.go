...
// PriceImpl item master get impl
type PriceImpl interface {
	GetPrices(req PriceGetRequest) (PriceGetResponce, error)
}

// PriceGetRequest struct
...
// PriceGetResponce struct
type PriceGetResponce struct {
	// 商品リスト
